...
%%
spectra_pix=squeeze(im_uc(204,358,:));
Y_spk_only=reshape(Y_spk,9,231);
Y_spk_5=Y_spk_only(5,:);
wavelength=wvl_94F6()';
Y_shp_recorr=[wavelength corr_spectra_pix Y_spectra_n_corr Y_spk_5'];
Y_shp_recorr_orig=[wavelength spectra_pix Y_spectra_n_corr];
xlswrite('pix_shp_corr.xls', Y_shp_recorr);
xlswrite('pix_shp_corr_orig.xls', Y_shp_recorr_orig);
%%
% var=1;
% yline=y_loc-1;
% for i=1:3
