...
clc
%load your image 
fnameIn='C:\Users\arunsaranathhome\Downloads\IMAGES\CRISM\MTRDR\FRT000094F6\FRT000094F6_07_IF166J_TER3_CAT_despike_cropMTRDR_dark_pixel_ratioed.img';
opt=2;
%read whole image
...
s1=sprintf('original pixel at %d and sample no %d',y_loc,x_loc);
hleg=legend(s,s1);
hold off
axis([0 250 1.5 1.9])
